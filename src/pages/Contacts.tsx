...
import { Search, Filter, Plus, MoreHorizontal, Phone, Mail, Linkedin, Edit2, Trash2, Upload, Download, Eye } from "lucide-react";
...
export default function Contacts() {
  ...
  const handleViewLinkedIn = (contact: Contact) => {
                  ...
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={() => handleViewLinkedIn(contact)}>
